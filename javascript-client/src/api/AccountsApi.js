(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/InlineResponse2002', '../model/InlineResponse2001', '../model/InlineResponse201', '../model/AccountProperties', '../model/InlineResponse200'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/InlineResponse2002'), require('../model/InlineResponse2001'), require('../model/InlineResponse201'), require('../model/AccountProperties'), require('../model/InlineResponse200'));
  } else {
    // Browser globals (root is window)
    if (!root.CoinbaseApi) {
      root.CoinbaseApi = {};
    }
    root.CoinbaseApi.AccountsApi = factory(root.CoinbaseApi.ApiClient, root.CoinbaseApi.InlineResponse2002, root.CoinbaseApi.InlineResponse2001, root.CoinbaseApi.InlineResponse201, root.CoinbaseApi.AccountProperties, root.CoinbaseApi.InlineResponse200);
  }
}(this, function(ApiClient, InlineResponse2002, InlineResponse2001, InlineResponse201, AccountProperties, InlineResponse200) {
  'use strict';
